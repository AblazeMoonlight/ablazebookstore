...
import edu.ablazebookstore.models.Payment;
...
public class PaymentCrud {
    ...
    public  String createStripCustomer(){
        ...
        try {
            Stripe.apiKey =
            "sk_test_51HyOw3GGT9dICYbuMisMVBamAlnMI5GaioB0bLrtFBHl1U5nz75fnkkaxneFHn5eWB3f7muBIFM6he1Tp8pi6MCf00XDL9N8oR";
...
//            .build();
            ...
            customerParametre.put("email","customerA@gmail.com");
...
////        //createStripCustomer();
////         
////        //retriveStripeCustomer("cus_IZZlIIQDP0V41A");
////        
//        addStripeCard("");
////        chargeStripCard();
//    }
